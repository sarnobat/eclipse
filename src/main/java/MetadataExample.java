...
import org.apache.commons.imaging.formats.tiff.TiffImageMetadata.Item;
...
public class MetadataExample {
	public static void main(String[] args) throws ImageReadException,
			IOException {
		metadataExample(Paths
				.get("/e/Sridhar/Photos/camera phone photos/iPhone/2015-04-28/Madrid/2015-04-28 499.jpg")
				.toFile());
	}
	...
	public static void metadataExample(final File file)
		...
		if (metadata instanceof JpegImageMetadata) {
			...
			if (gpsLatitudeRefField != null && gpsLatitudeField != null
				...
				final String gpsLatitudeRef = (String) gpsLatitudeRefField
						.getValue();
